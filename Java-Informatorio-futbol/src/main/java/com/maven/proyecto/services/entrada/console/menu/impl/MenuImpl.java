...
public class MenuImpl implements Menu {
    ...
    public Scanner menuCrearEquipo() {
        try {
            ...
            System.out.println("2- Buscar detalles de un jugador por su nombre");
            System.out.println("3- Ver detales del equipo ingresando nombre del entrenador y del capitan");
            System.out.println("4- Buscar un equipo por su nombre y mostrar detalles");
            System.out.println("5- Eliminar un equipo");
            System.out.println("6- Exportar la lista de los jugadores");
            System.out.println("7- Importar la lista de los jugadoes");
            ...
            if (buscarEquipo != null) {
                ...
                switch (respuesta) {
                    case 2:
                        ...
                        if (jugadorRespuesta != null) {
                            ...
                            System.out.println("\nNo se encontro ningun jugador con ese nombre");
                        }
                        System.out.println("\n------------------------------------------------");
                        break;
                    case 3:
                        ...
                        if (buscarEquipo.getEntrenador().getNombre().equals(scanner.nextLine())) {
                            ...
                            if (buscarCapitan != null) {
                                ...
                                System.out.println("Nombre del equipo: " + buscarEquipo.getNombre());
                                System.out
                                        .println("Nombre del entrenador: " + buscarEquipo.getEntrenador().getNombre());
                                System.out.println("Nombre del capitan: " + buscarCapitan.getNombre());
                            } else {
                                System.out.println("\nNo se econtro ese nombre o no es capitan");
                ...
                System.out.println(
                        "No tiene cargado ningun equipo o fue ingresado mal su nombre. Por favor pruebe creando uno");
            }
        } catch (Exception e) {

            if (e.getMessage().equals("Index 0 out of bounds for length 0")) {
                System.out.println("\n--------------------------------------------");
                System.out.println("\nNo tienen ningun equipo creado. Por favor cree uno.");
                System.out.println("\n--------------------------------------------");
            } else if (e.getMessage().substring(0, 17).equals("For input string:")) {
                System.out.println("\n--------------------------------------------");
                System.out.println("\nIngresaste un dato invalido. Por favor vuelva a comenzar");
                System.out.println("\n--------------------------------------------");
            } else {
