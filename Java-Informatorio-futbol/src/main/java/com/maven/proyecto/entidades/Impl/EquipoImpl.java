...
public class EquipoImpl implements Equipo {
    ...
    public Equipo crearEquipo(Scanner scanner) {
        ...
        System.out.println("1- Quieres crear los jugadores ahora ?");
    ...
    public void exportarJugadores(String rutaArchivo) {
        ...
        for (Jugador jgr : this.jugadores) {
            ...
            listaJugadores.add("ID=" + jgr.getID() + ", Nombre=" + jgr.getNombre() + ", Apellido=" + jgr.getApellido()
                    + ", Altura=" + jgr.getAltura() + ", posicion=" + jgr.getPosicion().getPosicion()
                    + ", cantidadDeGoles=" + jgr.getCantidadDeGoles() + ", cantidadDePartidos="
                    + jgr.getCantidadDePartidos() + ", esCapitan=" + esCapitan + ", numerosDeCamisetas="
                    + jgr.getNumerosDeCamisetas());
        }
    ...
    public void importarJugadores(String rutaArchivo) {
        ...
        try {
            ...
            for (int i = 0; i < contenido.size(); i++) {
                ...
                jugador.crearJugador(ID, nombre, apellido, altura, posicion, cantidadDeGoles, cantidadDePartidos,
                        esCapitan, numerosDeCamisetas);
