...
public class JugadorImpl extends Persona implements Jugador {
    ...
    public Jugador crearJugador(Scanner scanner) {
        ...
        System.out.println("\nIngresar el numero de su camiseta");
    ...
    public Jugador crearJugador(int ID, String nombre, String apellido, double altura, String posicion,
            int cantidadDeGoles, int cantidadDePartidos, boolean esCapitan, int numerosDeCamisetas) {
    ...
    public String toString() {
        return "Jugador{" + "ID=" + this.getID() + ", Nombre=" + this.getNombre() + ", Nombre=" + this.getApellido()
                + ", Altura=" + altura + ", posicion=" + posicion + ", cantidadDeGoles=" + cantidadDeGoles
                + ", cantidadDePartidos=" + cantidadDePartidos + ", esCapitan=" + esCapitan + ", numerosDeCamisetas="
                + numerosDeCamisetas + '}';
    }
